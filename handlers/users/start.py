...
async def is_jahon(msg: Message):
    await msg.answer('Не пиши такоеее')
...
#     )
#     await msg.answer('<b>Congratulations!</b>\nYou have finished the registration form.',
...
def register_user(dp: Dispatcher) -> None:
    ...
    dp.register_message_handler(is_jahon, text_contains=['poxuy','lox'])
